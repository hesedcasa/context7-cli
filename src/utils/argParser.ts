...
npx context7-cli                  start interactive CLI
npx context7-cli --commands       list all the available commands
npx context7-cli <command> -h     quick help on <command>
npx context7-cli <command> <arg>  run command in headless mode
