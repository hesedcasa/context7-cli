/**
 * Conductor Web UI - Frontend JavaScript
 */
    ...
    createAgentCard(agent) {
        ...
        card.innerHTML = `
            ...
            <div class="agent-actions">
                <button class="btn btn-primary btn-small" onclick="conductor.showTaskModal('${agent.id}')">
                    Assign Task
                </button>
                <button class="btn btn-secondary btn-small" onclick="conductor.viewDiff('${agent.id}')">
                    View Changes
                </button>
                ${agent.status === 'running' ?
                    `<button class="btn btn-danger btn-small" onclick="conductor.stopAgent('${agent.id}')">Stop</button>` :
                    `<button class="btn btn-danger btn-small" onclick="conductor.removeAgent('${agent.id}')">Remove</button>`
                }
            </div>
        `;
...
// Initialize the UI
const conductor = new ConductorUI();
